CLASS /dmo/cx_flight_legacy21 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_21',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_21',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id21 OPTIONAL
        booking_id            TYPE /dmo/booking_id21 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id21 OPTIONAL
        agency_id             TYPE /dmo/agency_id21 OPTIONAL
        customer_id           TYPE /dmo/customer_id21 OPTIONAL
        carrier_id            TYPE /dmo/carrier21-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_21-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_21-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date21 OPTIONAL
        end_date              TYPE /dmo/end_date21 OPTIONAL
        booking_date          TYPE /dmo/booking_date21 OPTIONAL
        flight_date           TYPE /dmo/flight_date21 OPTIONAL
        status                TYPE /dmo/travel_status21 OPTIONAL
        currency_code         TYPE /dmo/currency_code21 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id21,
          mv_booking_id            TYPE /dmo/booking_id21,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id21,
          mv_agency_id             TYPE /dmo/agency_id21,
          mv_customer_id           TYPE /dmo/customer_id21,
          mv_carrier_id            TYPE /dmo/carrier21-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_21-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_21-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date21,
          mv_end_date              TYPE /dmo/end_date21,
          mv_booking_date          TYPE /dmo/booking_date21,
          mv_flight_date           TYPE /dmo/flight_date21,
          mv_status                TYPE /dmo/travel_status21,
          mv_currency_code         TYPE /dmo/currency_code21,
...
CLASS /dmo/cx_flight_legacy21 IMPLEMENTATION.
