...
INTERFACE /dmo/if_flight_legacy21
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL21
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel21     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING21
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking21    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_21
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_21 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT21
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight21 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id21.
  ...
  TYPES booking_id TYPE /dmo/booking_id21.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id21.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL21, /DMO/BOOKING21, /DMO/BOOK_SUP_21 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code21.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code21,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status21,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel21_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id21.
  INCLUDE TYPE /dmo/booking21_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id21.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id21.
  INCLUDE TYPE /dmo/book_sup_21_data.
